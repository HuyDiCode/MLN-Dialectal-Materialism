...
const TimelineSection: React.FC = () => {
  return (
    <section id="timeline-section" className="timeline-section">
      ...
      <Parallax speed={-2} className="timeline-footer">
        <div className="timeline-conclusion">
          <h3>The Journey Continues</h3>
          <p>
            Every milestone marks not an end, but a beginning. As we move forward, 
            we carry with us the lessons learned and the vision that drives us toward 
